<x-app-layout>
    <x-page-title page="Lista de Roles" header="Lista de Roles" />
    ...
    <div class="space-y-4">
        ...
        <div class="flex flex-col items-center justify-between gap-y-4 md:flex-row md:gap-y-0">
            <!-- Search -->
            <form method="GET" action="{{ route('roles.index') }}" class="group flex h-10 w-full items-center rounded-primary border border-transparent bg-white shadow-sm focus-within:border-primary-500 focus-within:ring-1 focus-within:ring-inset focus-within:ring-primary-500 dark:border-transparent dark:bg-slate-800 dark:focus-within:border-primary-500 md:w-72">
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th class="w-[85%] uppercase">Modulo</th>
                    ...
                    @foreach($roles as $role)
                        <tr>
                            ...
                            <td class="text-right">
                                    ...
                                    <div class="dropdown" data-placement="bottom-start">
                                        ...
                                        <div class="dropdown-content">
                                            <ul class="dropdown-list">
                                                <li class="dropdown-list-item">
                                                    <a href="{{ route('roles.edit', $role->id) }}" class="dropdown-link">
                                                        <i class="h-5 text-slate-400" data-feather="edit"></i>
                                                        <span>Editar</span>
                                                    </a>
                                                </li>
                                                <li class="dropdown-list-item">
                                                    <a href="javascript:void(0)" class="dropdown-link" data-toggle="modal" data-target="#deleteModal-{{ $role->id }}">
                                ...
                                <!-- Modal excluir -->
                                <div class="modal modal-centered" id="deleteModal-{{ $role->id }}">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p class="text-sm text-slate-500 dark:text-slate-300">
                                                    Tem certeza que deseja excluir <strong>{{ $role->name }}</strong>?
                                                </p>
                                            </div>
